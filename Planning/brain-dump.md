...
So unless you ask for hash signatures, you get a smaller file.
You can always update an existing snapshot to add the hashes.
impl: on update, backup existing file, stream new file with space for hashes (that will be calculated afterwards)
