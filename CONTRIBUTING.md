# Contributing to ajfs

Thank you so much for contributing to ajfs. I appreciate your time and help.
...
If you have questions regarding ajfs, feel free to ask it by raising an Issue and label it as a `question`.
...
1. If you believe you've found a bug, please provide detailed steps of
   reproduction, the version of ajfs and anything else you believe will be
...
1. Fork the project.
1. Download your fork to your computer (`git clone https://github.com/your_username/ajfs && cd ajfs`)
